...
CATEGORIES: dict[str, list[str]] = {
    "Alimentação": [
        ...
        "assai", "atacadista", "coop", "outback", "giraffas",
        "madero", "bk ", "burger king", "kfc", "starbucks",
    ],
    "Transporte": [
        ...
        "ipva", "dpvat", "veiculo", "veículo", "99pop", "cabify",
    ],
    "Casa": [
        ...
        "net", "oi ", "sky", "reforma", "copafer", "leroy", "telha norte",
        "ring ", "ring.com",
    ],
    "Saúde": [
    ...
    "Lazer": [
        ...
        "clube", "academia", "esporte", "youtube", "evo ", "smart fit",
        "livelo", "clube livelo",
    ],
    "Compras": [
        ...
        "kalunga", "wish", "brinquedo", "pb kids", "xiaomi", "mimo",
    ],
    "Assinaturas/Software": [
        ...
        "claude", "anthropic", "1password", "bitwarden", "cursor",
    ],
    "Seguros": [
        "porto seguro", "bradesco seguro", "tokio marine", "sulamerica",
        "mapfre", "allianz", "azul seguro", "seguro ", "seguradora",
    ],
    "Animais": [
        "petlove", "petz", "cobasi", "petshop", "pet shop", "veterina",
        "multivet", "clinica vet", "vacina pet", "racao", "ração",
    ],
    "Viagem": [
